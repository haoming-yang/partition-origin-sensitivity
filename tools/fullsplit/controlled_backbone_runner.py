...
if __name__=='__main__':
 ap=argparse.ArgumentParser(); ap.add_argument('--model',choices=('Transformer','MLP','Conv'),required=True); ap.add_argument('--dataset',choices=('ETTh1','Weather'),required=True); ap.add_argument('--seed',type=int,required=True); ap.add_argument('--out',type=Path,required=True); a=ap.parse_args(); run(a.model,a.dataset,a.seed,a.out)
